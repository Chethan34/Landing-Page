...
export default function Navbar() {
  return (
    <motion.nav
      className="fixed w-full z-50 bg-black h-20 shadow-md"
      ...
      <div className="container mx-auto px-4 py-5 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <div className="hidden md:flex ml-8">
            <ul className="flex space-x-6">
              ...
              <li>
                <a href="#" className="text-white text-base font-semibold hover:text-gray-300">Enterprise</a>
              </li>
              <li>
                <a href="#" className="text-white text-base font-semibold hover:text-gray-300">Pricing</a>
              </li>
            </ul>
          </div>
        </div>
        <div className="flex items-center space-x-4">
          <button className="text-white text-base font-normal flex items-center hover:text-gray-300">
            <Globe className="w-5 h-5 mr-2" strokeWidth={1} />
            Contact sales
          </button>
